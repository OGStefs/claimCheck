const fundaes = [
  ...
  {
    inputs: [
      { internalType: "address payable", name: "_newWallet", type: "address" },
    ],
    name: "changeTreasury",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "uint8", name: "_maxBuy", type: "uint8" }],
    name: "setMaxBuy",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
...
export default fundaesContract;
