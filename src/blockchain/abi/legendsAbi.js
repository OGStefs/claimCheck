const legends = [
  {
    inputs: [
      { internalType: "address", name: "_apeLiquidAddress", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256[]", name: "_apeLiquidIds", type: "uint256[]" },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_liquidReserve", type: "uint256" },
    ],
    name: "setReserve",
    outputs: [],
    stateMutability: "nonpayable",
...
export default legendsContract;
